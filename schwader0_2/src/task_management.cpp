...
void TaskManager::beginn() {
	...
	//spinner left (mainly for use from auto function)
	...
	task_list[TSKPART_SPINNER_RIGHT_UP_TWO_SENS] = new CylinderTwoSensorTaskpart(
			...
			5000);*/
	task_list[TSKPART_SPINNER_LEFT_TO_MIDDLE] = new MessageMoveToSensorTaskpart(
			TSKPART_SPINNER_LEFT_TO_MIDDLE,
			TYPE_MESSAGE,
			...
			SENS_FRAME_MIDDLE,
			5000);
	task_list[TSKPART_SPINNER_LEFT_TO_LOW] = new MessageMoveToSensorTaskpart(
			TSKPART_SPINNER_LEFT_TO_LOW,
			TYPE_MESSAGE,
			MSG_TSKPART_FRAME_TO_MIDDLE,
			MSG_IN_FRAME_DOWN,
			MSG_IN_FRAME_UP,
	...
	//spinner up -> spinner complete up
