...
void TaskManager::beginn() {
	...
	task_list[TSKPART_FRAME_DOWN] = new CylinderSensorTaskpart(
			...
			SENS_FRAME_LOW,
			5000);
	//spinner up two sensor -> stop on 1/3 or up-position
	task_list[TSKPART_SPINNER_LEFT_UP_TWO_SENS] = new CylinderTwoSensorTaskpart(
			TSKPART_SPINNER_LEFT_UP_TWO_SENS,
			TYPE_MESSAGE,
			MSG_TSKPART_SPINNER_LEFT_UP_TWO_SENS,
			OUT_SPINNER_LEFT_UP,
			...
			5000);
	task_list[TSKPART_SPINNER_RIGHT_UP_TWO_SENS] = new CylinderTwoSensorTaskpart(
			TSKPART_SPINNER_RIGHT_UP_TWO_SENS,
			TYPE_MESSAGE,
			MSG_TSKPART_SPINNER_RIGHT_UP_TWO_SENS,
			...
			5000);
	//spinner up -> only when spinner is complete up
	task_list[TSKPART_SPINNER_LEFT_UP] = new CylinderSensorTaskpart(
			...
			SENS_SPINNER_LEFT_UP,
			5000);
	task_list[TSKPART_SPINNER_RIGHT_UP] = new CylinderSensorTaskpart(
			...
			5000);
	//spinnertele in
	task_list[TSKPART_SPINNER_TELE_LEFT_IN] = new CylinderSensorTaskpart(
			TSKPART_SPINNER_TELE_LEFT_IN,
			TYPE_MESSAGE,
			MSG_TSKPART_SPINNER_TELE_LEFT_IN,
			OUT_SPINNER_LEFT_TELE_IN,
			OUT_SPINNER_LEFT_TELE_OUT,
			CYLINDER_FUNCTION_1,
			SENS_SPINNER_LEFT_TELE_IN,
			5000);
	task_list[TSKPART_SPINNER_TELE_RIGHT_IN] = new CylinderSensorTaskpart(
			TSKPART_SPINNER_TELE_RIGHT_IN,
			TYPE_MESSAGE,
			MSG_TSKPART_SPINNER_TELE_RIGHT_IN,
			OUT_SPINNER_RIGHT_TELE_IN,
			OUT_SPINNER_RIGHT_TELE_OUT,
			CYLINDER_FUNCTION_1,
			SENS_SPINNER_RIGHT_TELE_IN,
			5000);
	//rahmen bis mitte oder oben hochfahren
	task_list[TSKPART_FRAME_UP_TWO_SENS] = new CylinderTwoSensorTaskpart(
			TSKPART_FRAME_UP_TWO_SENS,
			TYPE_MESSAGE,
			MSG_TSKPART_FRAME_UP_TWO_SENS,
			OUT_FRAME_UP,
			OUT_FRAME_DOWN,
			CYLINDER_FUNCTION_1,
			SENS_FRAME_UP,
			...
			5000);
	//weeltele in
	task_list[TSKPART_WEEL_TELE_LEFT_IN] = new CylinderSensorTaskpart(
			TSKPART_WEEL_TELE_LEFT_IN,
			TYPE_MESSAGE,
			MSG_TSKPART_WEEL_TELE_LEFT_IN,
			OUT_WEEL_TELE_LEFT_IN,
			OUT_WEEL_TELE_LEFT_OUT,
			CYLINDER_FUNCTION_1,
			SENS_WEEL_TELE_LEFT_IN,
			5000);
	task_list[TSKPART_WEEL_TELE_RIGHT_IN] = new CylinderSensorTaskpart(
			TSKPART_WEEL_TELE_RIGHT_IN,
			TYPE_MESSAGE,
			MSG_TSKPART_WEEL_TELE_RIGHT_IN,
			OUT_WEEL_TELE_RIGHT_IN,
			OUT_WEEL_TELE_RIGHT_OUT,
			CYLINDER_FUNCTION_1,
			SENS_WEEL_TELE_RIGHT_IN,
			5000);
	//different frame down tasks
	task_list[TSKPART_FRAME_DOWN_TO_GROUND] = new MessageSensorTaskpart(
			TSKPART_FRAME_DOWN_TO_GROUND,
			TYPE_MESSAGE,
			MSG_TSKPART_FRAME_DOWN_TO_GROUND,
			MSG_IN_FRAME_DOWN,
			SENS_FRAME_GROUND,
			5000);
	task_list[TSKPART_FRAME_DOWN_TO_MIDDLE] = new MessageSensorTaskpart(
			TSKPART_FRAME_DOWN_TO_MIDDLE,
			TYPE_MESSAGE,
			MSG_TSKPART_FRAME_DOWN_TO_MIDDLE,
			MSG_IN_FRAME_DOWN,
			SENS_FRAME_MIDDLE,
			5000);
