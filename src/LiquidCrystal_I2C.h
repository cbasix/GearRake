...
public:
   ...
   LiquidCrystal_I2C (uint8_t lcd_Addr, uint8_t backlighPin, int pol);
   ...
   /*!
    ...
    LCD_5x10DOTS.
    */
   virtual void begin(uint8_t cols, uint8_t rows, uint8_t charsize = 5);
    ...
    */
   void setBacklightPin ( uint8_t value, int pol );
...
private:
   ...
   int   _i2cio;            // I2CIO PCF8574* expansion module driver I2CLCDextraIO
